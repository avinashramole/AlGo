...
export const fallbackSnapshot: Snapshot = {
  ...
  algos: [
    ...
    { id: "a3", name: "ORB Breakout", tag: "Index", status: "PAUSED", pnl: -412, winRate: 54, enabled: false, brokerId: "paper" },
  ],
  positions: [
    { id: "p1", symbol: "NIFTY 24500 CE", type: "BUY", qty: 75, avg: 128.4, ltp: 142.75, pnl: 1076.25, brokerId: "paper" },
    { id: "p2", symbol: "BANKNIFTY 52100 PE", type: "SELL", qty: 30, avg: 186.2, ltp: 164.5, pnl: 651, brokerId: "paper" },
    { id: "p3", symbol: "NIFTY 24600 CE", type: "BUY", qty: 50, avg: 74.1, ltp: 88.2, pnl: 705, brokerId: "paper" },
  ],
  signals: [
