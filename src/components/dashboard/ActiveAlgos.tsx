          ...
          <div key={algo.id} className="flex items-center gap-3 rounded-xl border border-[var(--border)] px-3 py-2.5">
            <div className="flex-1">
              ...
              <div className="mt-1 flex flex-wrap gap-3 text-[11px] text-slate-400">
                ...
                <span>{algo.kind === "nifty-vwap-hedge" ? "15m hedge" : algo.kind === "nifty-vwap-reversal" ? "15m VWAP" : algo.kind === "nifty-vwap" ? "NIFTY VWAP" : algo.kind === "price-action" ? "Price action" : algo.tag}</span>
