  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-slate-400">
        Buy / Sell is a MIS market order for {lots} lot ({qty} qty). This page shows one chain: ATM ±10 strikes, next 4
        expiries. The desk looks up the Dhan contract on the server. Orders reach Dhan only while the live Access Token
        is connected.
      </p>
    </div>
  );
