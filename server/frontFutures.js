  ...
  const rows = [...strikes]
    ...
    .map((strike) => {
      ...
      return {
        ...
        callBid: Number(live.callBid || synth.callBid || 0),
        callAsk: Number(live.callAsk || synth.callAsk || 0),
        callBuy: Number(live.callBuy || synth.callBuy || 0),
        callSell: Number(live.callSell || synth.callSell || 0),
        callVwap: Number(live.callVwap || synth.callVwap || 0),
        callId,
        ...
        putBid: Number(live.putBid || synth.putBid || 0),
        putAsk: Number(live.putAsk || synth.putAsk || 0),
        putBuy: Number(live.putBuy || synth.putBuy || 0),
        putSell: Number(live.putSell || synth.putSell || 0),
        putVwap: Number(live.putVwap || synth.putVwap || 0),
        putId,
